<h2><a href="https://leetcode.com/problems/maximum-points-activated-with-one-addition">4249. Maximum Points Activated with One Addition</a></h2><h3>Hard</h3><hr><p>You are given a 2D integer array <code>points</code>, where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents the coordinates of the <code>i<sup>th</sup></code> point. All coordinates in <code>points</code> are <strong>distinct</strong>.</p>
