<h2><a href="https://leetcode.com/problems/design-event-manager">4267. Design Event Manager</a></h2><h3>Medium</h3><hr><p>You are given an initial list of events, where each event has a unique <code>eventId</code> and a <code>priority</code>.</p>
...
<ul>
	<li><code>EventManager(int[][] events)</code> Initializes the manager with the given events, where <code>events[i] = [eventId<sub>i</sub>, priority<sub>âââââââi</sub>]</code>.</li>
