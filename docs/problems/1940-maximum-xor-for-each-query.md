...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/maximum-xor-for-each-query/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/1940-maximum-xor-for-each-query){ .md-button }
