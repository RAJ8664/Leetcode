...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/lexicographically-smallest-equivalent-string/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/1058-lexicographically-smallest-equivalent-string){ .md-button }
