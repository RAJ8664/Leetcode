...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/adding-spaces-to-a-string/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/2232-adding-spaces-to-a-string){ .md-button }
