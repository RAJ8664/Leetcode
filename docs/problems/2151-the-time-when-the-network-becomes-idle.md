...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/the-time-when-the-network-becomes-idle/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/2151-the-time-when-the-network-becomes-idle){ .md-button }

---

<h2><a href="https://leetcode.com/problems/the-time-when-the-network-becomes-idle">2151. The Time When the Network Becomes Idle</a></h2><h3>Medium</h3><hr><p>There is a network of <code>n</code> servers, labeled from <code>0</code> to <code>n - 1</code>. You are given a 2D integer array <code>edges</code>, where <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>]</code> indicates there is a message channel between servers <code>u<sub>i</sub></code> and <code>v<sub>i</sub></code>, and they can pass <strong>any</strong> number of messages to <strong>each other</strong> directly in <strong>one</strong> second. You are also given a <strong>0-indexed</strong> integer array <code>patience</code> of length <code>n</code>.</p>
