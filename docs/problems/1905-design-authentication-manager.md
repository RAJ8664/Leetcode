...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/design-authentication-manager/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/1905-design-authentication-manager){ .md-button }
