...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/tuple-with-same-product/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/1364-tuple-with-same-product){ .md-button }

---

<h2><a href="https://leetcode.com/problems/tuple-with-same-product">1364. Tuple with Same Product</a></h2><h3>Medium</h3><hr><p>Given an array <code>nums</code> of <strong>distinct</strong> positive integers, return <em>the number of tuples </em><code>(a, b, c, d)</code><em> such that </em><code>a * b = c * d</code><em> where </em><code>a</code><em>, </em><code>b</code><em>, </em><code>c</code><em>, and </em><code>d</code><em> are elements of </em><code>nums</code><em>, and </em><code>a != b != c != d</code><em>.</em></p>
