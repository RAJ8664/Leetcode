...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/maximum-containers-on-a-ship/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/3817-maximum-containers-on-a-ship){ .md-button }
