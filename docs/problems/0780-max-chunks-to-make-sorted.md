...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/max-chunks-to-make-sorted/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/0780-max-chunks-to-make-sorted){ .md-button }
