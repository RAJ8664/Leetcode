...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/minimum-total-distance-traveled/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/2554-minimum-total-distance-traveled){ .md-button }
