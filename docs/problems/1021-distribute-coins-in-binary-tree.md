...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/distribute-coins-in-binary-tree/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/1021-distribute-coins-in-binary-tree){ .md-button }
