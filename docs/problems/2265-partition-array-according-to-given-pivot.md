...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/partition-array-according-to-given-pivot/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/2265-partition-array-according-to-given-pivot){ .md-button }
