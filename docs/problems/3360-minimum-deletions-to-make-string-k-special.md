...
[:octicons-link-external-24: LeetCode Problem](https://leetcode.com/problems/minimum-deletions-to-make-string-k-special/){ .md-button }
[:octicons-code-24: View on GitHub](https://github.com/RAJ8664/Leetcode/tree/master/3360-minimum-deletions-to-make-string-k-special){ .md-button }
