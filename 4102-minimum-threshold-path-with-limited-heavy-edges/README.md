...
<p>The graph is represented by a 2D integer array <code>edges</code>, where each edge <code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>, w<sub>âââââââi</sub>]</code> indicates that there is an undirected edge between nodes <code>u<sub>i</sub></code> and <code>v<sub>i</sub></code> with weight <code>w<sub>âââââââi</sub></code>.</p>
...
<p>&nbsp;</p>
<p><strong class="example">Example 1:</strong>ââââââââââââââ</p>

<p>âââââââ<img alt="" src="https://assets.leetcode.com/uploads/2025/10/13/g6.png" style="width: 324px; height: 200px;" /></p>
...
<ul>
	<li><code>1 &lt;= n &lt;= 10<sup>3</sup>âââââââ</code></li>
	<li><code>0 &lt;= edges.length &lt;= 10<sup>3</sup>âââââââ</code></li>
	<li><code>edges[i] = [u<sub>i</sub>, v<sub>i</sub>, w<sub>i</sub>]</code></li>
	<li><code>0 &lt;= u<sub>i</sub>, v<sub>i</sub>âââââââ &lt;= n - 1</code></li>
	<li><code>1 &lt;= w<sub>i</sub>âââââââ &lt;= 10<sup>9</sup></code></li>
