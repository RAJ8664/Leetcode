<h2><a href="https://leetcode.com/problems/create-grid-with-exactly-k-paths-i">4343. Create Grid With Exactly K Paths I</a></h2><h3>Medium</h3><hr><p>You are given three integers <code>m</code>, <code>n</code>, and <code>k</code>.</p>
