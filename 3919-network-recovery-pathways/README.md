<h2><a href="https://leetcode.com/problems/network-recovery-pathways">3919. Network Recovery Pathways</a></h2><h3>Hard</h3><hr><p data-end="502" data-start="75">You are given a directed acyclic graph of <code>n</code>â¯nodes numbered from 0â¯toâ¯<code>nâ¯&minus;â¯1</code>. This is represented by a 2D array <code data-end="201" data-start="194">edges</code> of length<font face="monospace"> <code>m</code></font>, where <code data-end="255" data-start="227">edges[i] = [u<sub>i</sub>, v<sub>i</sub>, cost<sub>i</sub>]</code> indicates a oneâway communication from nodeâ¯<code data-end="304" data-start="300">u<sub>i</sub></code> to nodeâ¯<code data-end="317" data-start="313">v<sub>i</sub></code> with a recovery cost ofâ¯<code data-end="349" data-start="342">cost<sub>i</sub></code>.</p>

<p data-end="502" data-start="75">Some nodes may be offline. You are given a boolean array <code data-end="416" data-start="408">online</code> where <code data-end="441" data-start="423">online[i] = true</code> means nodeâ¯<code data-end="456" data-start="453">i</code> is online. Nodes 0 and <code>nâ¯&minus;â¯1</code> are always online.</p>

<p data-end="547" data-start="504">A path from 0â¯to <code>nâ¯&minus;â¯1</code> is <strong data-end="541" data-start="532">valid</strong> if:</p>
...
<p data-end="771" data-start="653">For each valid path, define its <strong data-end="694" data-start="685">score</strong> as the minimum edgeâcost along that path.</p>
...
<ul data-end="551" data-start="146">
	...
	<ol data-end="462" data-start="209">
		...
		<ul data-end="462" data-start="343">
			...
			<p data-end="462" data-start="405">The minimum edgeâcost along this path is <code>min(3, 4) = 3</code>.</p>
			</li>
		</ul>
		</li>
	</ol>
	...
	<p data-end="551" data-start="465">There are no other valid paths. Hence, the maximum among all valid pathâscores is 3.</p>
	</li>
</ul>
</div>
...
<ul>
	...
	<ol data-end="1231" data-start="840">
		...
		<ul data-end="985" data-start="865">
			...
			<p data-end="985" data-start="928">The minimum edgeâcost along this path is <code>min(7, 5) = 5</code>.</p>
			</li>
		</ul>
		</li>
		...
		<ul data-end="1231" data-start="1111">
			...
			<p data-end="1231" data-start="1174">The minimum edgeâcost along this path is <code>min(6, 6) = 6</code>.</p>
			</li>
		</ul>
		</li>
	</ol>
