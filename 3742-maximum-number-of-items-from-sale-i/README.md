<h2><a href="https://leetcode.com/problems/maximum-number-of-items-from-sale-i">3742. Maximum Number of Items From Sale I</a></h2><h3>Medium</h3><hr><p>You are given a 2D integer array <code>items</code>, where <code>items[i] = [factor<sub>i</sub>, price<sub>i</sub>]</code> represents the <code>i<sup>th</sup></code> item. You are also given an integer <code>budget</code>.</p>
